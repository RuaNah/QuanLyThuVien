...
------BACKUP DỮ LIỆU
---FULL BACK UP
BACKUP DATABASE QUANLYTV
TO DISK='D:\FULLQUANLYTV.BAK'
WITH INIT
--LOG BACKUP
ALTER DATABASE TEST
SET RECOVERY FULL
...
BACKUP LOG QUANLYTV
to disk = 'D:\LOGQUANLYTV.trn'
--DIFFERENCE BACKUP
BACKUP DATABASE QUANLYTV
TO DISK = 'D:\DIFFQUANLYTV.BAK'
...
from disk = 'D:\FULLQUANLYTV.BAK'
with norecovery
restore database test
from disk = 'D:\DIFFQUANLYTV.BAK'
with norecovery
restore database test
from disk = 'D:\LOGQUANLYTV.trn'
with recovery	

---------TẠO TÀI KHOẢN ĐĂNG NHẬP QUẢN LÝ DATABASE--------
--TẠO NHÓM QUYỀN ADMIN ĐƯỢC TOÀN QUYỀN TRÊN CƠ SỞ DỮ LIỆU
GO
SP_ADDROLE ADMINDATA
GO
SP_ADDLOGIN ADMIN1,123
GO
SP_ADDUSER ADMIN1
GO
SP_ADDROLEMEMBER ADMINDATA,ADMIN1

GRANT SELECT,INSERT,UPDATE,DELETE
TO ADMINDATA
--TẠO NHÓM QUYỀN USER CHỈ ĐƯỢC XEM BẢN SÁCH TRONG CƠ SỞ DỮ LIỆU
GO
SP_ADDROLE USERDATA
GO
...
SP_ADDUSER USER1
GO
SP_ADDROLEMEMBER USERDATA,USER1
